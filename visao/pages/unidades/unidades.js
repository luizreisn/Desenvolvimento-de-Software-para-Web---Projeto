$(function(){
    ...
    $('#but1').click(function(){
        $('#desc1').toggle(500);
        if($('#but1').html() == '<i class="fas fa-chevron-up" style="font-size: 25pt;"></i>'){
    ...
    $('#but2').click(function(){
        $('#desc2').toggle(500);
        if($('#but2').html() == '<i class="fas fa-chevron-up" style="font-size: 25pt;"></i>'){
    ...
    $('#but3').click(function(){
        $('#desc3').toggle(500);
        if($('#but3').html() == '<i class="fas fa-chevron-up" style="font-size: 25pt;"></i>'){
    ...
    $('#but4').click(function(){
        $('#desc4').toggle(500);
        if($('#but4').html() == '<i class="fas fa-chevron-up" style="font-size: 25pt;"></i>'){
    ...
    $('#but5').click(function(){
        $('#desc5').toggle(500);
        if($('#but5').html() == '<i class="fas fa-chevron-up" style="font-size: 25pt;"></i>'){
    ...
    $('#but6').click(function(){
        $('#desc6').toggle(500);
        if($('#but6').html() == '<i class="fas fa-chevron-up" style="font-size: 25pt;"></i>'){
    ...
    $('#but7').click(function(){
        $('#desc7').toggle(500);
        if($('#but7').html() == '<i class="fas fa-chevron-up" style="font-size: 25pt;"></i>'){
    ...
    $('#but8').click(function(){
        $('#desc8').toggle(500);
        if($('#but8').html() == '<i class="fas fa-chevron-up" style="font-size: 25pt;"></i>'){
    ...
    $('#but9').click(function(){
        $('#desc9').toggle(500);
        if($('#but9').html() == '<i class="fas fa-chevron-up" style="font-size: 25pt;"></i>'){
    ...
    $('#but10').click(function(){
        $('#desc10').toggle(500);
        if($('#but10').html() == '<i class="fas fa-chevron-up" style="font-size: 25pt;"></i>'){
    ...
    $('#but11').click(function(){
        $('#desc11').toggle(500);
        if($('#but11').html() == '<i class="fas fa-chevron-up" style="font-size: 25pt;"></i>'){
    ...
    $('#but12').click(function(){
        $('#desc12').toggle(500);
        if($('#but12').html() == '<i class="fas fa-chevron-up" style="font-size: 25pt;"></i>'){
